    ...
    <header className="sticky top-0 z-40 w-full border-b border-black/10 bg-white/70 backdrop-blur supports-[backdrop-filter]:bg-white/60">
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        <div className="flex h-16 items-center justify-between">
          <Link href="/" className="flex items-left flex-col">
            <span className="text-lg font-semibold tracking-tight text-black">The Boring DevRels</span>
            <span className="text-xs font-normal tracking-tight text-black">By The Boring Education</span>
          </Link>
