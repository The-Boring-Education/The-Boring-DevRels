			...
			<div className="max-w-6xl mx-auto relative z-10">
				<FlexContainer direction="col" itemCenter className="gap-12 lg:gap-16 lg:flex-row">
					<div className="flex-1 text-center lg:text-left">
						<Text level="h1" className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-700 leading-tight">
							{title}
						</Text>
						...
						<FlexContainer className="mt-8 gap-4 justify-center lg:justify-start" direction="col" wrap={false}>
							<Link
								href="/apply"
								className="bg-primary hover:bg-[#ff6b6b] text-white px-8 py-4 rounded-xl shadow-lg shadow-[#ff5757]/25 text-lg font-semibold w-full sm:w-auto transition-all duration-300 hover:scale-105 inline-flex items-center justify-center"
							>
								{primaryCtaText}
							</Link>
							<Link
								...
								target="_blank"
								className="text-gray-700 underline hover:text-gray-700 text-center transition-colors duration-300 text-lg"
							>
								{secondaryCtaText}
							</Link>
						</FlexContainer>
					...
					<div className="flex-1 flex justify-center lg:justify-end">
						<div className="rounded-2xl border border-gray-200 bg-white/80 backdrop-blur-xl p-6 shadow-2xl relative">
							...
							<div className="absolute -bottom-3 -right-3 bg-primary text-white px-4 py-2 rounded-full text-sm font-semibold shadow-lg">
								🎯 Join Now
							</div>
						</div>
					</div>
