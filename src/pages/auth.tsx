...
const AuthPage: React.FC = () => {
  ...
  const handleGoogleSignIn = () => {
    ...
    // For now, this is a placeholder for the Google sign-in flow
    const googleOAuthUrl = `https://accounts.google.com/oauth/authorize?client_id=${process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID}&redirect_uri=${encodeURIComponent(window.location.origin + '/auth/callback')}&response_type=code&scope=email profile`;
    window.location.href = googleOAuthUrl;
  };

  if (loading) {
    return (
      <MainLayout title="Signing in..." showNavigation={false}>
  ...
  return (
    <MainLayout title="Sign In" description="Sign in to access your DevRel dashboard" showNavigation={false}>
              ...
              <div className="space-y-6">
                ...
                <div className="text-center">
                  <p className="text-sm text-gray-700">
                    ...
                    and{' '}
                    <a href="https://theboringeducation.com/privacy" className="text-blue-600 hover:text-blue-500">
                      Privacy Policy
                    </a>
                  </p>
                </div>
